...
def my_spo_extracting_function(line):
    ...
    predicate = extract_predicate(doc)
    objects = extract_object(doc)
    verbs[predicate] = {"subject":subject, "object":objects}
